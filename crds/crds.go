...
func New() *apiextensionsv1.CustomResourceDefinition {
	return mustT(ByName("news.migration.lambda.coffee"))
}

func Old() *apiextensionsv1.CustomResourceDefinition {
	return mustT(ByName("olds.migration.lambda.coffee"))
}
